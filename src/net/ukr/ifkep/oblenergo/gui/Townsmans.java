...
public class Townsmans extends JFrame implements ActionListener {
	...
	public Townsmans() {
		...
		MainFonClass mainPanel = new MainFonClass("img/fade.jpg");
	...
	private AbonentsTableModel getTableModel() {
		try {
			...
			final List<Abonents> abonent = dao.findTownsmens();
	...
	private void removeAbonent() {
		if (JOptionPane.showConfirmDialog(Townsmans.this,
			...
			try {
				...
				JOptionPane.showMessageDialog(Townsmans.this, e.getMessage());
			}
		}

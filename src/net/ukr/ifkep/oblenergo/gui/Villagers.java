...
public class Villagers extends JFrame implements ActionListener {
	...
	private AbonentsTableModel getTableModel() {
		try {
			...
			final List<Abonents> abonent = dao.findVillagers();
	...
	private void removeAbonent() {
		if (JOptionPane.showConfirmDialog(Villagers.this,
			...
			try {
				...
				JOptionPane.showMessageDialog(Villagers.this, e.getMessage());
			}
		}
